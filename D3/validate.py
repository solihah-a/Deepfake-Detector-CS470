...
if __name__ == '__main__':
    ...
    # Support both full-model checkpoints (from Trainer with fix_backbone=False)
    # and fc-only checkpoints.
    if any(k.startswith('model.') for k in state_dict.keys()):
        model.load_state_dict(state_dict)
    elif 'weight' in state_dict and 'bias' in state_dict and len(state_dict) == 2:
